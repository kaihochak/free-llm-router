...
export function ModelHero() {
  ...
  useEffect(() => {
    fetch('/api/v1/models/openrouter')
      .then((res) => res.json())
      .then((data) => setModelCount(data.count))
      .catch(() => {});
  }, []);
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="relative flex min-h-[70vh] flex-col items-center justify-center text-center">
        ...
        <p className="relative mt-4 max-w-2xl text-lg text-muted-foreground sm:text-xl">
          Always up-to-date. We track availability so you don't have to.
        </p>
